...
const PHASES = new Set(["BOOTSTRAPPING", "ADDRESSES_READY", "FUNDING_READY", "REHEARSAL_READY", "REHEARSAL_RUNNING", "STAKEHOLDER_READY", "STAKEHOLDER_RUNNING", "COMPLETE", "ABORTED", "UNAVAILABLE"]);
